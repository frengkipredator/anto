...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{asset('/css/adminlte/blue.css')}}">
    <!-- Morris chart -->
    <link rel="stylesheet" href="{{asset('/css/adminlte/morris.css')}}">
    <!-- jvectormap -->
    <link rel="stylesheet" href="{{asset('/css/adminlte/jquery-jvectormap-1.2.2.css')}}">
    <!-- Date Picker -->
    <link rel="stylesheet" href="{{asset('/css/adminlte/datepicker3.css')}}">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="{{asset('/css/adminlte/daterangepicker-bs3.css')}}">
    <!-- bootstrap wysihtml5 - text editor -->
    <link rel="stylesheet" href="{{asset('/css/adminlte/bootstrap3-wysihtml5.min.css')}}">
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <!-- jQuery 2.1.4 -->
    <script src="{{asset('/js/adminlte/jQuery-2.1.4.min.js')}}"></script>
    <!-- jQuery UI 1.11.4 -->
    ...
    <script src="{{asset('/js/adminlte/morris.min.js')}}"></script>
    <!-- Sparkline -->
    ...
    <!-- jQuery Knob Chart -->
    <script src="{{asset('/js/adminlte/jquery.knob.js')}}"></script>
    <!-- daterangepicker -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.10.2/moment.min.js"></script>
    <script src="{{asset('/js/adminlte/daterangepicker.js')}}"></script>
    <!-- datepicker -->
    <script src="{{asset('/js/adminlte/bootstrap-datepicker.js')}}"></script>
    <!-- Bootstrap WYSIHTML5 -->
    ...
    <!-- FastClick -->
    <script src="{{asset('/js/adminlte/fastclick.min.js')}}"></script>
    <!-- AdminLTE App -->
